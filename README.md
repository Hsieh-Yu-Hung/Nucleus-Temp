...
Nucleus is a command-line tool for analyzing genetic data from qPCR instruments. It not only supports the analysis of Fragile X, HTD, MTHFR, and SMA data but also seamlessly integrates with the _core_ function, allowing additional custom analyses via modules.1
...
- Copy numbers:
  ...
  | 2 copy      | DIFF21 \* 0.5               | DIFF21 _ 0.5 + DIFF32 _ 0.5 |
  | 3 copy      | DIFF21 _ 0.5 + DIFF32 _ 0.5 | value above count as 3 copy |
